...
export const SEED_RECORDS: HubRecord[] = [
  ...
  mk({
    ...
    resource: { externalUrl: 'https://www.youtube.com/watch?v=jSvdjpJM-pY', durationNote: '8 min watch' },
  }),
  mk({
    id: 'vid-standardmodel',
    type: 'video',
    title: 'What can the Standard Model tell us about new physics?',
    summary: 'A recorded live talk: why measuring known particles really precisely at the Large Hadron Collider is one of our best ways to hunt for physics we haven’t found yet.',
    ...
    resource: { externalUrl: 'https://www.youtube.com/watch?v=daegr1kTjvs', durationNote: 'Recorded talk' },
    body: 'Dr Ludovica Aperio Bella explains why “precision measurements” matter. The Standard Model is our best description of the building blocks of matter and the forces between them — but it can’t be the whole story. By measuring the particles we already know about with extreme care, physicists at the Large Hadron Collider can spot tiny differences from what the theory predicts, and those gaps are where new physics could be hiding.\n\nThe talk is pitched at a curious general audience — no equations needed — and is a good watch for older students and adults who want a feel for what particle physicists actually do.',
  }),
  mk({
    id: 'rex-batteries',
  ...
  mk({
    ...
    summary: 'Everything you need to launch a club that lasts a term — session plans, kit lists and a running order you can adapt.',
    body: 'This kit is built for a teacher or technician starting a STEM club from scratch. It maps out a full term of weekly sessions, each with a clear aim, a low-cost kit list and a back-up activity if equipment runs short.\n\nThe sessions are pitched at Key Stage 3 but flex up or down, and they lean on hands-on builds and challenges rather than worksheets. There is a short guide on recruiting members, keeping numbers manageable, and showing off what the club makes at the end of term.\n\nIf you would like the University to take part in person, you can also get in touch with our Schools & Colleges team, who run wider outreach and visits.',
    audiences: ['futurelab'],
    ageGroups: ['ks3'],
    subjects: ['general_stem'],
    usefulForTeachers: true,
